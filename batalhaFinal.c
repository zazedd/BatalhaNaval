...
int main(void)
{
    ...
    system("clear");
    printf("Por favor introduza qual a opção que pretende. Se colocar outro caracter qualquer, o programa encerra!\n");
    printf("1 - Iniciar Jogo Da Batalha Naval\n");
    printf("2 - Ajuda\n");
    printf("0 - Sair\n");
    printf("Opção:");
    scanf("%d", &option);
    ...
    printf("Vamos dar início ao jogo da Batalha Naval.\n");
    printf("Vamos começar por conhecer o nome dos jogadores!\n");
    ...
    printf("Boa sorte aos nossos jogadores, %s e %s!\n", nomeAtacante, nomeDefensor);

    printf("Vez do jogador Defensor.\nProceda à colocação dos barcos %s.\n", nomeDefensor);
    ...
    printf("O jogo será jogado por dois jogadores, dos quais um será o defensor, o que irá colocar barcos num tabuleiro, e o jogador atacante, o qual irá, em 40 jogadas, tentar adivinhar a posição dos barcos colocados pelo jogador defensor e assim afundá-los.\n");
    printf("Ganha o jogador defensor se, o oponente em 40 jogadas não conseguir afundar todos os barcos colocados por este. O jogador atacante ganhará se, afundar todos os barcos que o seu oponente tiver colocado. Lembrando que se o jogador atacante pode consultar o tabuleiro de jogo, embora se o fizer, perderá a partida mas podendo continuar a jogar.\n");
    }
    else if (option == 0)
    {
        break;
    ...
    {
        printf("A opção que selecionou não está de acordo com os parâmetros definidos no menu! Introduza novamente a opção pretendida!\n");
        scanf("%d", &option);
    }
